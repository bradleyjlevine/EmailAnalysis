...
##### Begin Retrieve Frequencies and Email Scrubbing #####
	...
	fields = ["From", "To", "Date"]
	r = bw(noise="Milestone4Del_BradleyLevine_JoshuaVasko.txt", compound="Milestone4Comp_BradleyLevine_JoshuaVasko.txt", map="Milestone4Sub_BradleyLevine_JoshuaVasko.txt")
